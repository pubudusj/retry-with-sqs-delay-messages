...
class RetryWithSqsDelayMessagesStack(Stack):
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        failed_message_processing_lambda = lambda_.Function(
            ...
            memory_size=128,
            environment={
                "TARGET_QUEUE_URL": source_queue.queue_url,
                "FINAL_DLQ_URL": final_dlq.queue_url,
            },
            retry_attempts=0,
        )
        ...
        # Add send message permission for source queue
        source_queue.grant_send_messages(failed_message_processing_lambda)
